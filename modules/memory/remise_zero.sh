...
rm -f Mw== NA== Mg== NQ== MQ== > /dev/null 2>&1

rm -rf basket football handball baseball rubgy > /dev/null 2>&1
...
function clean_up_after_error() {
    ...
    rm -f .encoded_0 .encoded_1 .encoded_2 .encoded_3 .encoded_4 > /dev/null 2>&1
